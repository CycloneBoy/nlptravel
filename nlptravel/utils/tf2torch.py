...
if __name__ == "__main__":
    ...
    bert = BertPlome(num_class=21128,
                     pyid2seq=None,
                     skid2seq=None,
                     py_dim=32,
                     max_sen_len=180,
    ...
    tf_checkpoint_path = "/home/sl/workspace/data/nlp/plome/datas/pretrained_plome/bert_model.ckpt"
    # tf_checkpoint_path = "./tf_model/bert_model.ckpt"

    print("torch:")
    for name, parameters in bert.named_parameters():
        print(name, parameters.shape)

    reader = tf.compat.v1.train.NewCheckpointReader(tf_checkpoint_path)
