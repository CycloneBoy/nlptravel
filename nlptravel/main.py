...
from nlptravel.model.csc.pre_trained_lm_misspelled_kg import BertPlome
from nlptravel.trainer import train
from nlptravel.utils import tokenization
from nlptravel.utils.pinyin_tool import PinyinTool
from nlptravel.utils.plome_utils import read_train_ds, get_zi_py_matrix, convert_single_example, MyData, collate_fn
...
def config():
    ...
    parser.add_argument("--pinyin_vocab_file_path", type=str, default="pinyin_vocab.txt",
                        help="pinyin vocab file path.")
...
if __name__ == "__main__":
    ...
    # 模型建立
    model = BertPlome(model_path=args.model_path,
                      num_class=len(label_list),
                      pyid2seq=PYID2SEQ, skid2seq=SKID2SEQ,
