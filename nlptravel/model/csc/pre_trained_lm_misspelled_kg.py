#!/user/bin/env python
# -*- coding: utf-8 -*-
# @File  : pre_trained_lm_misspelled_kg.py
# @Author: sl
# @Date  : 2022/4/5 - 上午9:44

import torch
from torch import nn

from nlptravel.model.pretrained.bert_modify import BertMeModel
...
class BertPlome(nn.Module):
    def __init__(self,
                 ...
                 num_class=21128,
                 max_sen_len=180,
                 dropout=0.1, model_path='bert-base-chinese', ):
        super().__init__()
        self.model = BertMeModel.from_pretrained(model_path)
